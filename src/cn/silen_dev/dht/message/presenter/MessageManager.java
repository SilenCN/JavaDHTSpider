...
import cn.silen_dev.dht.bittorrent.Contact;
...
public class MessageManager {
    DHTSocketServer socketServer;
    NodeList nodeList;
    public MessageManager(DHTSocketServer socketServer,NodeList nodeList) {
        super();
                    ...
                    if (null!=nodes){
                        ...
                        for (int i=0;i+26<bs.length;i+=26){
                            ...
                            if (nodeList.add(inetSocketAddress)){
                                ...
                                socketServer.seedPacket(inetSocketAddress,message);
                            }
                        }
                    }
                }
